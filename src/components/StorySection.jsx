      ...
      <div className="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
        <Card>
          <div className="p-6 sm:p-8" data-reveal="left">
            ...
            <div className="mt-6 rounded-card border border-line bg-cream px-4 py-4">
              <div className="text-xs font-semibold uppercase tracking-[0.16em] text-inkMuted">Follow along</div>
        ...
        <div className="grid gap-5">
          ...
          <Card>
            <div className="p-6" data-reveal="right">
              <div className="text-xs uppercase tracking-[0.22em] text-inkMuted">Collection</div>
              <h3 className="mt-3 text-2xl text-ink">{brand.collectionLocation}</h3>
              <p className="mt-3 text-sm leading-6 text-inkMuted">{brand.collectionNote}</p>
              <ul className="mt-4 space-y-3 text-sm leading-6 text-inkMuted">
