...
export default function Seo({ brand, menu, faq }) {
  useEffect(() => {
    const title = `${brand.name} | Saturday Cinnamon Rolls & Banana Cake in Singapore`;
    const description =
      "Reserve small-batch Saturday cinnamon rolls and banana cake from Swirl Girl in Singapore. Weekly pre-orders close Thursday at 10pm SGT.";
    const origin =
