const PHOTOS = [
  {
    ...
    alt: "Banana cake with a slice on a wooden board",
    className: "sm:col-span-2 sm:row-span-2",
  },
  {
    src: "/banana-bread-slices.webp",
    alt: "Sliced banana cake served on a ceramic plate",
    className: "sm:col-span-1",
  },
  {
    src: "/banana-bread-board.webp",
    alt: "Banana cake with a banana and baking tools on a wooden board",
    className: "sm:col-span-1",
  },
  {
    src: "/banana-bread-choc-chip.webp",
    alt: "A banana cake with chocolate chips on a wooden board",
    ...
    <section className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
      <div className="flex flex-wrap items-end justify-between gap-4" data-reveal="left">
        <div>
          ...
          <h2 className="mt-2 text-3xl text-ink sm:text-4xl">Banana cake, baked for sharing.</h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-inkMuted">
          A few scenes from our latest banana cake bake, from the first slice to the last crumb.
        </p>
      </div>
